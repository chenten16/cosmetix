...
<div class="box-25">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="banner__item mb-30 p-relative">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img src="{{asset('assets/img/shop/banner/banner-sm-1.jpg')}}" alt="banner"></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="banner__item mb-30 p-relative">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img src="{{asset('assets/img/shop/banner/banner-sm-2.jpg')}}" alt="banner"></a>
                        </div>
                        <div class="banner__content p-absolute transition-3">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="banner__item mb-30 p-relative">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img src="{{asset('assets/img/shop/banner/banner-sm-3.jpg')}}" alt="banner"></a>
                        </div>
                        <div class="banner__content p-absolute transition-3">
    ...
    <!-- product area start -->
    <livewire:store.product-sections.product-section1 className="" isnew="false" title="Trending Products" description="Mirum est notare quam littera gothica quam nunc putamus parum claram!" :products="$products"/>
    <!-- product area end -->
            ...
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6">
                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img src="{{asset('assets/img/shop/banner/banner-big-1.jpg')}}" alt="banner"></a>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class=" banner__item-2 banner-left p-relative mb-30 pl-15">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img src="{{asset('assets/img/shop/banner/banner-big-2.jpg')}}" alt="banner"></a>
                        </div>
    ...
    <!-- sale off area start -->
    <livewire:store.product-sections.product-section2 className="" isnew="false" title="Sale off" description="Mirum est notare quam littera gothica quam nunc putamus parum claram!" :products="$products"/>
    <!-- sale off area end -->

    <!-- blog area start -->
    <livewire:store.product-sections.product-section1 className="" isnew="true" title="New Arrivals" description="Mirum est notare quam littera gothica quam nunc putamus parum claram!" :products="$products"/>
