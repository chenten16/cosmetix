    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <!--begin::Wrapper-->
                <div class="card-px text-center py-20 my-2">
                    <!--begin::Title-->
                    <h2 class="fs-2x fw-bolder mb-10">Welcome!</h2>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <p class="text-gray-400 fs-4 fw-bold mb-10">There are no products added yet.
                        <br>Kickstart your store by adding a your first product
                    </p>
                    <!--end::Description-->
                    <!--begin::Action-->
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#product_modal">Add Product</a>
                    <!--end::Action-->
                </div>
                <!--end::Wrapper-->
                <!--begin::Illustration-->
                <div class="text-center px-4">
                    <img class="mw-100 mh-300px" alt="" src="{{asset('adminAssets/media/illustrations/sketchy-1/2.png')}}">
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Card body-->
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" class="form-control form-control-solid w-250px ps-14" placeholder="Search Products" id="searchProduct" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        <div class="card-body pt-0">
            <table id="product_table" class="table table-row-bordered gy-5">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img class="rounded-circle" src="{{Storage::url($product->preview_image)}}" style="max-height: 80px;width: 80px;" alt=""> </td>
                        <td>{{$product->name}}</td>
                        <td>${{$product->price}}</td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 edit" wire:click="$emit('editProduct',{{$product->id}})">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" wire:click="$emit('deleteProduct',{{$product->id}})" class="menu-link px-3">Delete</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
