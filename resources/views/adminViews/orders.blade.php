		...
		<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
			...
			<div class="page-title d-flex flex-column me-5">
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<a href="{{route('adminOrders')}}" class="text-muted text-hover-primary">Orders</a>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Orders" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            <tr>
                                ...
                                <!--begin::Status=-->
                                <td>
                                    <div class="badge badge-light-success">Shipped</div>
                                </td>
                                <!--end::Status=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Status=-->
                                <td>
                                    <div class="badge badge-light-warning">Shipping</div>
                                </td>
                                <!--end::Status=-->
...
<script src="{{asset('adminAssets/js/custom/apps/subscriptions/list/export.js')}}"></script>
<script src="{{asset('adminAssets/js/custom/apps/subscriptions/list/list.js')}}"></script>
