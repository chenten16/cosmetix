                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">500M$</div>
                            <div class="fw-bold text-gray-100">Sales</div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="fw-bold text-white">Avg Customers</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">$50,000</div>
                            <div class="fw-bold text-white">Profit</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
            ...
            <div class="row g-5 g-xl-8">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Latest Orders</span>
                                <span class="text-muted mt-1 fw-bold fs-7"><a href="#">View More</a> </span>
                            </h3>
                            <div class="card-toolbar">
                                ...
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61322ed0414a5">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61322ed0414a5" data-allow-clear="true">
                                                    <option></option>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Trending Products</span>
                                <span class="text-muted mt-1 fw-bold fs-7"><a href="#">View More</a> </span>
                            </h3>
                            <div class="card-toolbar">
                                <ul class="nav">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="adminAssets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="adminAssets/media/svg/brand-logos/telegram.svg" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="adminAssets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="adminAssets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="adminAssets/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
